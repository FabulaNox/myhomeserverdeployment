...
func SplitHostname(named reference.Named) (string, string) {
	// reference.SplitHostname does not exist in github.com/distribution/reference
	// Use splitDomain from reference.go instead
	// Local copy of splitDomain from github.com/distribution/reference/reference.go
	name := named.Name()
