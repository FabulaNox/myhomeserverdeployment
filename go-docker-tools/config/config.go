...
// Platform-aware default config dir
func GetDefaultConfigDir() string {
	if runtime.GOOS == "windows" {
		return os.Getenv("APPDATA") + "\\go-docker-tools"
	}
	if xdg := os.Getenv("XDG_CONFIG_HOME"); xdg != "" {
		return xdg + "/go-docker-tools"
	}
	return os.Getenv("HOME") + "/.config/go-docker-tools"
}

// Platform-aware default backup dir
func GetDefaultBackupDir() string {
	return GetDefaultConfigDir() + "/backups"
}

// Platform-aware default Docker socket
